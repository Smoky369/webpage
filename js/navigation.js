...
function returnToInitScreen() {
  ...
  landingScreen.classList.add('is-transitioning');
  ...
  setTimeout(() => {
    ...
    landingScreen.classList.remove('is-transitioning');
  }, 1000);
}
...
export function initNavigation() {
  ...
  document.addEventListener('click', (event) => {
    ...
    if (sideMenu.contains(event.target) || menuToggle.contains(event.target)) return;
