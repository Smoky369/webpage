...
const fileNameCycle = document.getElementById('file-name-cycle');
const landingNameCycle = document.getElementById('landing-name-cycle');
...
const fileNames = ['manish_pathak369', 'मनिष_पाठक३६९'];
...
export function initTyping() {
  ...
  setInterval(() => {
    ...
    const currentFileName = fileNames[fileNameIndex];
    fileNameCycle.textContent = currentFileName;
    landingNameCycle.textContent = currentFileName;
    ...
    booksButton.addEventListener('click', () => {
      ...
      modalContent.innerHTML = `
        ...
        <div class="books-grid">
          ...
          <img src="./images/book5.jpeg" alt="Book cover" />
          <img src="./images/book6.jpeg" alt="Book cover" />
        </div>
      `;
    });
  }
